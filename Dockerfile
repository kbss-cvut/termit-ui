...
RUN REACT_APP_SERVER_URL=${SERVER_URL} REACT_APP_DEPLOYMENT_NAME=${DEPLOYMENT} REACT_APP_ADMIN_REGISTRATION_ONLY=${REACT_APP_ADMIN_REGISTRATION_ONLY} REACT_APP_SHOW_PUBLIC_VIEW_ON_UNAUTHORIZED=${REACT_APP_SHOW_PUBLIC_VIEW_ON_UNAUTHORIZED} REACT_APP_GOOGLE_LOGIN=${REACT_APP_GOOGLE_LOGIN} REACT_APP_GITHUB_LOGIN=${REACT_APP_GITHUB_LOGIN} npm run build-prod
