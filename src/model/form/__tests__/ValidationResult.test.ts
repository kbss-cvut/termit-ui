...
describe("ValidationResult", () => {
    ...
    describe("fromOntoValidationResult", () => {
        it("constructs instance even when message in specified locale is not available", () => {
            ...
            const formResult = FormValidationResult.fromOntoValidationResult(ontoResult, "en");
        ...
        it("constructs instance with correct severity", () => {
            ...
            const errorFormResult = FormValidationResult.fromOntoValidationResult(errorResult, "cs");
            ...
            const warningFormResult = FormValidationResult.fromOntoValidationResult(warningResult, "cs");
