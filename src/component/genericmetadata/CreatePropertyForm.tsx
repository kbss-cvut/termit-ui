...
export class CreatePropertyForm extends React.Component<CreatePropertyFormProps, CreatePropertyFormState> {
    ...
    public render() {
        ...
        return (
            <div>
                <ModalHeader toggle={this.props.toggleModal}>{i18n("properties.edit.new")}</ModalHeader>
                <ModalBody>
                    <Row>
                        <Col xs={12}>
                    ...
                    <Row>
                        <Col xs={12}>
                            <ButtonToolbar className="float-right">
                                <Button color="success" size="sm" onClick={this.onCreate} disabled={!this.isValid()}>
                                    {i18n("save")}
                                </Button>
                                <Button size="sm" onClick={this.props.toggleModal}>
                                    {i18n("cancel")}
                                </Button>
                            </ButtonToolbar>
                        </Col>
