...
export class FileContentLink extends React.Component<
  FileContentLinkProps,
  FileContentLinkState
> {
...
export default connect(undefined, (dispatch: ThunkDispatch) => {
  return {
    getContentType: (iri: string) =>
      dispatch(getContentType(VocabularyUtils.create(iri))),
  };
