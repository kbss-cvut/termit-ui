...
const ResourceMetadata = (props: ResourceMetadataProps) => {
    const {i18n} = useI18n();
    return <div className={classNames({"card": !props.inTab, "mb-3": !props.inTab})}>
        <CardBody className={classNames("card-body-basic-info", {"pl-0": props.inTab})}>
            {props.inTab && <Row>
                <Col xl={2} md={4}>
                    <Label className="attribute-label mb-3">{i18n("asset.label")}</Label>
                </Col>
                <Col xl={10} md={8}>
            ...
            <Row>
                <Col xl={2} md={4}>
                    <Label className="attribute-label mb-3">{i18n("resource.metadata.description")}</Label>
                </Col>
                <Col xl={10} md={8}>
