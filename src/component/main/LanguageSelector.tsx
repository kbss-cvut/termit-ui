...
export class LanguageSelector extends React.Component<LanguageSelectorProps> {
    ...
    public render() {
        ...
        return <UncontrolledDropdown className={classNames({
            "p-3": !authenticated
        })}>
            <DropdownToggle
            ...
            <DropdownMenu right={true}>
                <DropdownItem name="language-selector.cs" onClick={this.onSelect.bind(null, Constants.LANG.CS.locale)}>
                    <img src={Constants.LANG.CS.flag} className="flag"
                         alt={Constants.LANG.CS.label}/>&nbsp;&nbsp;{Constants.LANG.CS.label}</DropdownItem>
                <DropdownItem divider={true}/>

                <DropdownItem nane="language-selector.en"
                              onClick={this.onSelect.bind(null, Constants.LANG.EN.locale)}>
                    <img src={Constants.LANG.EN.flag} className="flag"
                         alt={Constants.LANG.EN.label}/>&nbsp;&nbsp;{Constants.LANG.EN.label}</DropdownItem>
            </DropdownMenu>
