...
import {loadFileContent, loadVocabulary, saveFileContent} from "../../action/AsyncActions";
import {IRI} from "../../util/VocabularyUtils";
import {ThunkDispatch} from "../../util/Types";
import Annotator from "../annotator/Annotator";
import {clearFileContent, consumeNotification} from "../../action/SyncActions";
...
export class FileContentDetail extends React.Component<FileDetailProps, FileDetailState> {
    ...
    private initializeTermFetching = (): void => {
        ...
        this.props.fetchTerms(this.props.vocabularyIri).then(() => this.setState({termsLoading: false}));
    };
