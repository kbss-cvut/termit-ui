...
interface RelatedTermsSelectorProps extends HasI18n {
    ...
    loadTerms: (fetchOptions: FetchOptionsFunction, namespace?: string) => Promise<Term[]>;
}
...
export class RelatedTermsSelector extends React.Component<RelatedTermsSelectorProps> {
    ...
    public fetchOptions = (
        ...
        return this.props.loadTerms(
            ...
            fetchOptions.optionID ? VocabularyUtils.create(fetchOptions.optionID).namespace : undefined
            )
            .then((terms) => {
