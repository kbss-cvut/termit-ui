...
export class Terms extends React.Component<GlossaryTermsProps, TermsState> {
    ...
    constructor(props: GlossaryTermsProps) {
        ...
        const includeImported = Utils.extractQueryParam(props.location.search, "includeImported") === true.toString();
    ...
    private onConfirmedOnlyToggle = () => {
        this.setState({confirmed: !this.state.confirmed}, () => this.treeComponent.current.resetOptions());
    };
    ...
    public render() {
        ...
        Object.keys(this.state.unusedTermsForVocabulary).forEach(vocabularyIri =>
            Array.prototype.push.apply(unusedTerms, this.state.unusedTermsForVocabulary[vocabularyIri])
        );
