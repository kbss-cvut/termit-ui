...
export class TermMetadataEdit extends React.Component<TermMetadataEditProps,
                ...
                <Card id="edit-term">
                    <CardBody>
                        <Form>
                            ...
                            <Row>
                                <Col xs={12}>
                                    <RelatedTermsSelector id="edit-term-related" termIri={this.props.term.iri}
                                                          selected={Term.consolidateRelatedAndRelatedMatch(this.state)}
