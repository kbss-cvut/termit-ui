...
describe("Validation Results", () => {
    ...
    it("groups results by term and orders them most problematic first", () => {
        ...
        const validationResults = {
            [term.iri]: [constructValidationResult(term.iri), constructValidationResult(term.iri)],
            [anotherTermIri]: [constructValidationResult(anotherTermIri)]
        };
        const component = shallow<ValidationResults>(
            <ValidationResults term={term} validationResults={validationResults} {...intlFunctions()} />
        );
