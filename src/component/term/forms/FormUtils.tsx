...
export function renderValidationMessages(locale: string, validationResults: ValidationResult[]) {
    return <>
        {validationResults.map(r => {
            const message = Utils.sanitizeArray(r.message).find(ls => ls.language === getShortLocale(locale))!.value;
