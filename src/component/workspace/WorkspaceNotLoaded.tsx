...
const WorkspaceNotLoaded: React.FC<WorkspaceNotLoadedProps> = (props) => {
  ...
  return (
    <div id="workspace-not-loaded" className="wrapper main-container">
...
export default connect((state: TermItState) => ({ loading: state.loading }))(
  injectIntl(withI18n(WorkspaceNotLoaded))
);
