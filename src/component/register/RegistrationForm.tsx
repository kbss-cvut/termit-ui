...
export class RegistrationForm extends React.Component<RegistrationFormProps, RegistrationFormState> {
    ...
    private renderMask() {
        return this.props.loading ? <Mask text={this.props.i18n("register.mask")} classes="mask-container" /> : null;
    }
        ...
        if (this.passwordsMatch()) {
            return (
                <EnhancedInput
                    ...
                    valid={this.isValidPassword() && true}
