...
describe("RegistrationForm", () => {
    ...
    it("displays submit button disabled when inputs are empty", () => {
        const wrapper = mountWithIntl(
            <MemoryRouter>
                <RegistrationForm loading={false} register={register} cancel={cancel} {...intlFunctions()} />
            </MemoryRouter>
        );
    ...
    it("disables submit button when loading", () => {
        const wrapper = mountWithIntl(
            <MemoryRouter>
                <RegistrationForm loading={true} register={register} cancel={cancel} {...intlFunctions()} />
            </MemoryRouter>
        );
        fillBasicUserInfo(wrapper);
        fillPasswords(wrapper);
    ...
    it("renders alert with error when register fails", () => {
        ...
        register = jest.fn().mockResolvedValue({status: AsyncActionStatus.FAILURE, error});
        const wrapper = shallow<RegistrationForm>(
            <RegistrationForm loading={false} register={register} cancel={cancel} {...intlFunctions()} />
        );
