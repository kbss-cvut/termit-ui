...
export class VocabularySummary extends EditableComponent<VocabularySummaryProps, VocabularySummaryState> {
    ...
    public render() {
        ...
        if (!this.state.edit) {
            buttons.push(
                <IfUserAuthorized key="vocabulary-summary-edit" renderUnauthorizedAlert={false}>
                    <Button
        ...
        buttons.push(
            <IfUserAuthorized key="vocabulary-summary-remove" renderUnauthorizedAlert={false}>
                <Button
