...
vi.mock("../../misc/PromiseTrackingMask", () => ({
  default: () => <span>Mask</span>,
}));
...
describe("Create vocabulary view", () => {
  ...
  beforeEach(() => {
    ...
    vi.spyOn(Redux, "useSelector").mockReturnValue(Constants.DEFAULT_LANGUAGE);
  });
