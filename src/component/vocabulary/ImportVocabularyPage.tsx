...
export const ImportVocabularyPage = (props: ImportVocabularyPageProps) => {
    const createFile = (file: File, rename: Boolean) => props.importVocabulary(file, rename).then(onCancel)
...
export default connect(undefined, (dispatch: ThunkDispatch) =>
    ({
        importVocabulary: (file: File, rename: Boolean) => dispatch(importSkosAsNewVocabulary(file, rename))
    })
