        ...
        <Modal isOpen={props.show} toggle={props.onCancel}>
            ...
            <ModalFooter>
                <ButtonToolbar className="pull-right">
                    <Button id="remove-asset-submit" color="primary" size="sm" onClick={props.onSubmit}>
                        {i18n("remove")}
                    </Button>
                    <Button id="remove-asset-cancel" color="outline-dark" size="sm" onClick={props.onCancel}>
                        {i18n("cancel")}
                    </Button>
                </ButtonToolbar>
            </ModalFooter>
