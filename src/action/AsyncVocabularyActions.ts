...
export function loadTermCount(vocabularyIri: IRI) {
    ...
    return (dispatch: ThunkDispatch) => {
        ...
        return Ajax.get(`${Constants.API_PREFIX}/vocabularies/${vocabularyIri.fragment}/terms/count`,
            param("namespace", vocabularyIri.namespace).accept(Constants.JSON_MIME_TYPE))
            .then((res: number) => dispatch(asyncActionSuccessWithPayload(action, res)))
