...
function initTermFetching(fetchOptions: FetchOptionsFunction, includeCanonical?: boolean) {
    const action = {
...
export function loadTermsIncludingCanonical(fetchOptions: FetchOptionsFunction) {
