...
const en = {
  ...
  messages: {
    ...
    "vocabulary.summary.export.ttl.withRefs.title": "Export a SKOS-compatible glossary including terms from other vocabularies referenced via the exact match relationship, serialized as Turtle.",
