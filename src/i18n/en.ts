...
const en = {
    ...
    messages: {
        ...
        "resource.metadata.document.files.actions.remove": "Remove file",
        "resource.metadata.document.files.actions.remove.tooltip": "Remove file",
        "resource.metadata.document.files.actions.remove.dialog.title": "Do You Really want to remove the file?",
